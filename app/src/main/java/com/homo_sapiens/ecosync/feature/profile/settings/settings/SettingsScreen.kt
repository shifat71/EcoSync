package com.homo_sapiens.ecosync.feature.profile.settings.settings
...
import com.homo_sapiens.ecosync.util.extension.shareAppLink
import com.homo_sapiens.ecosync.feature.profile.settings.settings.component.*
...
private fun SettingsScreen(
    ...
    val activeMode = viewModel.activeMode.collectAsState(DarkMode.FOLLOW_SYSTEM).value
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            LazyColumn(
                ...
                darkModeButton(activeMode, viewModel::toggleTheme)
                item {
                    Divider(
                        modifier = Modifier
                            .height(1.dp)
